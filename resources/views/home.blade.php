...
@section('content')
    <div class="nunito flex flex-col justify-center min-h-screen py-12 bg-gray-50 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-center">
            <div class="flex flex-col justify-around">
                <div class="space-y-6">
                    <a href="{{ route('home') }}">
                        <div class="w-auto h-16 mx-auto text-indigo-600 logo"></div>
                    </a>

                    <h1 class="font-nunito text-5xl font-extrabold tracking-wider text-center text-gray-600">
                        {{ config('app.name') }}
                    </h1>
